...
env.roledefs = {
    'internal': ['kali@192.168.52.134'],  # 服务器地址,ssh登录
}
env.PROJECT_NAME = 'jowon'
env.SETTINGS_BASE = 'typeidea/typeidea/settings/base.py'

env.DEPLOY_PATH = '/home/kali/Desktop/jowon/'  # 部署路径
env.VENV_ACTIVE = os.path.join(env.DEPLOY_PATH, 'bin/', 'activate')
env.PYPI_HOST = '192.168.52.134'
